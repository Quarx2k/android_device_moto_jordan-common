...
static const struct sensor_t sSensorList[] = {
    ...
    { "AK8973 3-axis Magnetic Field Sensor",
        ...
        360.0f, AK8973_CONVERT_M, 4.0f, MS_50, 0, 0, { 0} }, // can use more power because values are unstables (cpu)
    ...
    { "ISL29030 Proximity Sensor",
        ...
        100.0f, 1.0f, 25.0f, 0, 0, 0, {0 } }, // (IR LED can use a lot of battery)

    { "ISL29030 Light Sensor",
        "Intersil Corporation",
        1, SENSORS_HANDLE_BASE + SENSOR_TYPE_LIGHT, SENSOR_TYPE_LIGHT,
        8192.0f, 1.0f, 0.5f, 0, 0, 0, {0 } },
};
