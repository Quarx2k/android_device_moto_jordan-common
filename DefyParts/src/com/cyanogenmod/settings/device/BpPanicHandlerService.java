...
public class BpPanicHandlerService extends Service {
    ...
    private static final String ACTION_HANDLE_PANIC = "com.cyanogenmod.settings.device.action.HANDLE_BP_PANIC";
    static final String ACTION_TIMER_UPDATE = "com.cyanogenmod.settings.device.action.TIMER_UPDATE";
    static final String ACTION_REBOOT = "com.cyanogenmod.settings.device.action.BP_PANIC_REBOOT";
    static final String ACTION_SNOOZE = "com.cyanogenmod.settings.device.action.REMIND_LATER";
    static final String ACTION_DISMISS = "com.cyanogenmod.settings.device.action.DISMISS";
